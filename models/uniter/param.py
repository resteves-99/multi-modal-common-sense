...
def parse_args():
    ...
    parser.add_argument('--max_seq_length', type=int, default=128, help='max sequence_length')
    ...
    parser.add_argument('--load_pretrained', dest='load_pretrained', type=str, default='/models/uniter-base.pt',
